...
// Изменяем опросы
$polls_data = [
    ['Какая алгебраическая функция вам нравится больше?', 
     json_encode(['Линейная', 'Квадратичная', 'Кубическая', 'Показательная'])],
    ['Какой раздел алгебры сложнее?', 
     json_encode(['Основы', 'Уравнения', 'Функции'])]
];
